        ...
        <div class="card o-hidden border-0 shadow-lg my-5 notice_form">
            <div class="card-body p-0">
                ...
                <div class="p-5">
                    ...
                    <form action="/admin/notice/write" method="post" style="display:inline;" class="user">
                    	<input type="hidden" name="admin_name" value="${admin_name }">
                        <p class="text-gray-800 text-right">작성자 : ${admin_name }</p>
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="10" 
                                name="content" id="content" placeholder="내용..."></textarea>
                        </div>
                        <div class="form-group">
                            <p class="text-gray-800">중요 공지 여부</p>
                            <div class="d-flex flex-row">
                                <div class="form-check pr-3">
                                    <input class="form-check-input" type="radio" name="important" id="radio1" value="1" checked>
